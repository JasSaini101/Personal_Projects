'''Created a healthbar for the enemy instances that goes down as they get hit.
Once their entire health has been taken away, the enemy then dissappears to show them as dead.
Along with this, a scoreboard has been added to the top right of the screen. It says 'Score: '
and is followed by a number that starts at 0 and counts up as the player successfully hits
the enemies. The health bar is essentially 2 rectangles onto of each other. One red rectangle
hidden behind a green rectangle, as the enemy gets hit, the green rectangle gets smaller which
makes the red rectangle appear and shows the lost health.'''
